...
class AmphibianViewModel : ViewModel() {
    ...
    private val _amphibiansState = MutableLiveData<AmphibiansState>()
    val amphibiansState: LiveData<AmphibiansState> get() =  _amphibiansState

    private val _amphibianState = MutableLiveData<AmphibianState>()
    val amphibianState: LiveData<AmphibianState> get() =  _amphibianState
...
//    val amphibian: LiveData<Amphibian> get() =  _amphibian
    ...
    private fun getAmphibians(){
        viewModelScope.launch {
            try {
                _amphibiansState.postValue(AmphibiansState(AmphibianAPI.retrofitService.getAmphibians(), AmphibianApiStatus.DONE))
            } catch (e: IOException) {
                _amphibiansState.postValue(AmphibiansState(listOf(), AmphibianApiStatus.DONE))
            }
        }
    ...
    fun onAmphibianClicked(amphibian: Amphibian) {
        ...
        _amphibianState.value = AmphibianState(amphibian, AmphibianApiStatus.DONE)
    }
